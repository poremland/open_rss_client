...
- **File Encoding:** UTF-8.
- **Whitespace:** Use only ASCII horizontal tabs (0x09). Spaces are forbidden for indentation.
...
- **Indentation:** +1 tab for each new block.
- **Semicolons:** Every statement must be terminated with a semicolon.
- **Column Limit:** 80 characters.
- **Line-wrapping:** Indent continuation lines at least +2 tabs.
