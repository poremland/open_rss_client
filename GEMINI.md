...
YOU RUN TESTS USING `bun test`.
THIS PROJECT IS MIGRATING FROM JEST TO BUN AS ITS PRIMARY AND SOLE TEST RUNNER.
YOU SHOULD PORT ANY NEW TESTS TO BUN DIRECTLY.
